...
        会发现我们的新烧录好的设备里面没有CUDA和TensorRT，那么这时候我们便需要进一步安装JetPack了，JetPack 是 Nvidia为 [Jetson](https://github.com):[wgetcloud加速器官网下载](https://longdu.org)系列开发板开发的一款软件开发包里面包含了常见的所有工具，并且在安装 JetPack的时候，会自动的帮你匹配所需CUDA、cuDNN、TensorRT等，我们在终端中输入以下命令：
...
至此我们的安装全部结束啦！！！
 ...
 - **本文链接：** [https://github.com/SkyXZ/p/18636647](https://github.com)
